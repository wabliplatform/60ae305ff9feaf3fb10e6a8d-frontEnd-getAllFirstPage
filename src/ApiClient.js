...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://wabli-solid-spoon.cyclopt.services:3011/v1
         */
        this.basePath = 'https://wabli-solid-spoon.cyclopt.services:3011/v1'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://wabli-solid-spoon.cyclopt.services:3011/v1",
